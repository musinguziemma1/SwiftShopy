    ...
    const plans = [
      {
        ...
        features: [
          "Storefront creation",
          "WhatsApp order button (pre-filled messages)",
          "Mobile money payments (MTN)",
          "Basic order tracking",
          "Simple dashboard (sales + orders)",
          "Basic customer list",
      ...
      },
      {
        ...
        features: [
          ...
          "Custom store link (yourbrand.swiftshopy.com)",
      ...
      },
      {
        ...
        features: [
          ...
          "Customer tagging (VIP, repeat buyers)",
          "Bulk product upload",
